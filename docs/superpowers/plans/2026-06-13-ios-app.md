...
- [x] **Step 2: Add KeychainAccess via SPM**
...
- [x] **Step 3: Write SupabaseConfig.swift**
...
- [x] **Step 5: Create `ios/docs/` with engineering standards seed**
...
- [x] **Step 4: Write DanceStyle.swift**
...
- [x] **Step 1: Write DateUtils.swift**
...
- [x] **Step 2: Write TextUtils.swift**
...
- [x] **Step 3: Write SchengenCalculator.swift**
...
- [x] **Step 4: Write ReviewScoring.swift**
...
- [x] **Step 1: Write SupabaseServiceProtocol.swift**
...
- [x] **Step 2: Write SupabaseService.swift**
...
- [x] **Step 1: Write AuthServiceProtocol.swift**
...
- [x] **Step 2: Write AuthService.swift**
...
- [x] **Step 1: Write AppModel+Types.swift**
...
- [x] **Step 3: Update SalsaEventTrackerApp.swift**
...
- [x] **Step 2: Write LoginView.swift**
...
- [x] **Step 3: Create stub views to satisfy compiler**
...
- [x] **Step 1: Write EventCard.swift**
...
- [x] **Step 2: Write EventListView.swift (full)**
...
- [x] **Step 3: Write EventDetailSheet.swift**
...
- [x] **Step 1: Write CalendarDayCell.swift**
...
- [x] **Step 2: Write CalendarView.swift (full)**
...
- [x] **Step 1: Write FestivalRow.swift**
...
- [x] **Step 2: Write FestivalListView.swift (full)**
...
- [x] **Step 2: Write TripsView.swift (full)**
...
- [x] **Step 3: Create stub TripEditorView**
...
- [x] **Step 1: Write TripPlaceRow.swift**
...
- [x] **Step 2: Write PTODayRow.swift**
...
- [x] **Step 3: Write TripEditorView.swift (full)**
...
- [x] **Step 1: Write ReviewCard.swift**
...
- [x] **Step 2: Write ReviewEditorView.swift**
...
- [x] **Step 3: Write ReviewsView.swift (full)**
...
- [x] **Step 1: Add recently added section to FestivalListView**
...
- [x] **Step 1: Add error banner to RootView**
...
- [x] **Step 2: Add pull-to-refresh on EventListView**

Add `.refreshable { await model.loadPublicData() }` to the `ScrollView` in `EventListView`.

- [x] **Step 3: Add pull-to-refresh on TripsView and ReviewsView**
...
actor MockSupabaseService: SupabaseServiceProtocol {
    ...
    // Actors require methods for external mutation
...
- [x] **Step 2: Test SchengenCalculator**
...
- [x] **Step 4: Test AppModel data loading (using mock)**
...
struct AppModelLoadingTests {
    ...
    func authExpiryClearsState() async {
        let mock = MockSupabaseService()
        let model = AppModel(supabase: mock)
        // Simulate what loadPrivateData's 401 catch block does
...
- [x] `AppModel+Types.swift` exists; no `enum` or support type is defined inline in `AppModel.swift`
- [x] `SupabaseServiceProtocol` and `AuthServiceProtocol` exist; both concrete types adopt them
- [x] No file in `ios/` exceeds its hard line limit (400 views, 500 services, 500 AppModel, 200 models)
- [x] No auth token, user ID, or private data appears in any `print()` or `os_log` call
- [x] `SupabaseConfig.swift` is the only file that references the Supabase URL and anon key
- [x] `ios/docs/engineering-standards.md` exists with the content from the Engineering Standards section of this plan
- [x] Unit tests pass (`SchengenCalculator`, `TextUtils`, `AppModel` loading — all via mock services)
